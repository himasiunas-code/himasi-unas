import { KegiatanData } from "@/lib/type/Kegiatan";

// Data daftar artikel kegiatan HIMASI per periode
export const kegiatanData: KegiatanData[] = [
  {
    ...
    description: `Himpunan Mahasiswa Sistem Informasi Universitas Nasional (HIMASI UNAS) menerima kunjungan istimewa dari Himpunan Mahasiswa Sistem Informasi Institut Teknologi Kalimantan (HMSI ITK). Bertempat di Ruang Seminar Universitas Nasional, kegiatan studi banding ini mengangkat tema "A Brainstorming Approach to Improve Quality & Inter-Organizational Collaboration."<br><br>
    Kunjungan yang berlangsung pada Senin, 12 Agustus 2024 ini bukan sekadar ajang silaturahmi, melainkan forum strategis untuk bertukar wawasan (benchmarking). Didampingi oleh Bapak I Putu Deny Arthawan Sugih Prabowo, S.Kom., M.Eng selaku dosen pembimbing, rombongan HMSI ITK disambut hangat oleh pengurus HIMASI UNAS yang didukung oleh Lembaga Sertifikasi Profesi Informatika (LSPI).<br><br>
    Agenda utama pertemuan ini meliputi pemaparan profil organisasi, bedah program kerja (proker), serta diskusi mendalam mengenai tantangan dan inovasi dalam pengelolaan himpunan mahasiswa di era digital.<br><br>
    Wakil Dekan Fakultas Teknologi Komunikasi dan Informatika (FTKI) UNAS, Ibu Ir. Endah Tri Esthi, MMSI, yang turut hadir memberikan sambutan, mengapresiasi inisiatif kedua himpunan ini. Beliau menegaskan bahwa kegiatan pertukaran pelajar dan studi banding seperti ini memiliki nilai strategis, tidak hanya bagi pengembangan soft skill mahasiswa, tetapi juga sebagai poin pendukung dalam proses akreditasi fakultas.<br><br>
    ...
    image: "/image/Home/Kegiatan/himasi-unas-x-hmsi-itk.png",
    buttonText: "Baca",
    period: "2024/2025"
  },
  {
    ...
    subtitle: "Kegiatan 2",
    date: "26 Mei 2025",
    description: `Himpunan Mahasiswa Sistem Informasi (HIMASI) bersama Program Studi Informatika Universitas Nasional sukses menggelar kegiatan Company Visit ke PT. Torabika Eka Semesta (Mayora Group) di Cikupa, Tangerang. Dilaksanakan pada Senin, 26 Mei 2025, kunjungan industri ini mengusung tema relevan: "Highlighting the Role of Data Analysts in Business Transformation."<br><br>
    Rombongan mahasiswa FTKI UNAS disambut langsung oleh jajaran manajemen PT. Torabika, termasuk Bapak Bayu Irawan (Factory Manager), Bapak Soekma Swasono Darmawan (HRBP), dan Bapak Darwanto (Manager Industrial Relations & GA).<br><br>
    Dalam kunjungan ini, mahasiswa diajak melihat langsung ekosistem produksi salah satu perusahaan FMCG (Fast-Moving Consumer Goods) terbesar di Indonesia. Kegiatan meliputi observasi alur produksi, mulai dari pengolahan bahan baku hingga distribusi barang jadi (finish good), serta bagaimana teknologi informasi terintegrasi dalam setiap lini operasional pabrik.<br><br>
    ...
    Kegiatan ini turut didampingi oleh Ketua Program Studi Sistem Informasi, Dr. Andrianingsih, S.Kom., M.M.S.I., dan Ketua Program Studi Informatika, Ratih Titi Komalasari, S.T., M.M., M.M.S.I.<br><br>
  ...
  },
  {
    ...
    description: `Divisi Research and Development (R&D) Himpunan Mahasiswa Sistem Informasi (HIMASI) Universitas Nasional sukses menggelar workshop teknologi bertajuk "Peningkatan Business Intelligence pada Platform Google Colab Menggunakan Bahasa Python".<br><br>
    Bertempat di Laboratorium Data Science (Blok IV, Lt 4) Universitas Nasional , kegiatan ini menghadirkan Bapak Pungky Hari Wira Atmaja, S.Kom., MMSI sebagai narasumber utama.<br><br>
    Workshop ini dirancang untuk menjawab tantangan dunia kerja yang semakin berorientasi pada data. Dalam pemaparannya, Pungky Hari Wira Atmaja mengajak peserta untuk memahami peran vital Business Intelligence (BI) dalam membantu organisasi mencapai tujuan strategisnya.<br><br>
    Mahasiswa dibekali keterampilan praktis (practical skills) untuk mengolah data secara optimal menggunakan teknologi modern, yakni bahasa pemrograman Python yang dijalankan di atas platform Google Colab.<br><br>
  ...
  },
  {
    ...
    subtitle: "Kegiatan 4",
    date: "15 Mei 2025",
    description: `Program podcast andalan Himpunan Mahasiswa Sistem Informasi (HIMASI) UNAS, "Cermasi: Cerita Bersama Himasi", kembali menyapa pendengar dengan topik yang sangat relevan bagi mahasiswa teknologi masa kini.<br><br>
    Dipandu oleh Raihan Fernandi, episode kali ini menghadirkan sosok akademisi sekaligus praktisi programming, Bapak Pungky Hari Wira Atmaja, S.Kom., MMSI. Diskusi berjalan hangat mengupas tuntas tentang pentingnya penguasaan Data Science dan Business Intelligence di era digital.<br><br>
    Data Science: Wajib atau Sunnah? Ketika ditanya mengenai urgensi belajar data bagi mahasiswa, Pungky memberikan jawaban tegas. "Mahasiswa di mana pun, program studi apa pun, sebaiknya senang dengan Data Science. Semua sekarang bisa diukur dengan data," ujarnya.<br><br>
    Beliau mencontohkan kasus kebocoran data nasional yang pernah terjadi sebagai bukti betapa krusialnya pemahaman tentang data. Menurutnya, kemampuan mengolah data statistik menjadi insight bisnis (Data Mining) adalah kompetensi wajib yang harus dimiliki mahasiswa saat ini.<br><br>
    Tantangan Belajar: "Jangan Patah Saat Jatuh" Pungky tidak menampik bahwa mempelajari Data Science memiliki tantangan tersendiri. Namun, ia menekankan bahwa kuncinya ada pada tekad.<br><br>
    "Biasanya kita kalau mau belajar itu pas sudah jatuh, patah nih, nggak mau lanjut lagi. Kenapa? Karena kita nggak tahu mau nanya ke siapa," jelas Pungky. Solusinya, menurut beliau, adalah aktif mencari mentor dan berdiskusi dengan teman atau dosen, bukan memendam kesulitan sendirian.<br><br>
    AI vs Manusia: Siapa yang Menang? Diskusi semakin menarik saat menyinggung fenomena kecerdasan buatan seperti ChatGPT dan DeepSeek. Pungky memandang AI sebagai alat bantu, bukan ancaman yang akan sepenuhnya menggantikan manusia.<br><br>
    "AI itu kan yang menciptakan manusia. Sepintar-pintarnya AI, masih ada error-nya. Kita sebagai manusia harus lebih pintar, jangan telan mentah-mentah jawaban dari AI," pesannya. Ia mengingatkan mahasiswa untuk tetap memverifikasi informasi dari AI dengan literatur yang valid.<br><br>
  ...
  },
  {
    ...
    subtitle: "Kegiatan 5",
    date: "18 Juni 2025",
    description: `Himpunan Mahasiswa Sistem Informasi (HIMASI) Universitas Nasional sukses melaksanakan kegiatan kunjungan industri (Company Visit) ke PT Sari Teknologi (Robopark) yang berlokasi di Pluit, Jakarta Utara.<br><br>
    Mengusung tema besar "Bridging Campus and Industry", kegiatan ini bertujuan untuk mempersempit jurang antara teori akademik di kampus dengan realita kebutuhan industri teknologi masa kini.<br><br>
  ...
  },
  {
    ...
    Kegiatan yang berlangsung pada Rabu, 9 Juli 2025 ini bertujuan untuk memperluas perspektif mahasiswa mengenai perkembangan teknologi komputer terkini serta standar penulisan ilmiah di tingkat internasional.<br><br>
      Belajar Langsung dari Pakar Internasional Agenda utama kunjungan ini adalah serangkaian workshop intensif yang menghadirkan akademisi terkemuka dari UCSI University. Mahasiswa HIMASI UNAS mendapatkan kesempatan langka untuk mendalami tiga topik krusial:<br>
      1. Perkembangan Teknologi Komputer yang dibawakan oleh Dr. Ts Raenu Kolandaisamy.<br>
      2. Penulisan Jurnal Ilmiah oleh Associate Professor Ts Dr. Shayla Islam, memberikan wawasan tentang bagaimana menembus publikasi riset bereputasi global.<br>
      3. Penerapan Artificial Intelligence (AI) yang dipaparkan oleh Prof. Dr. Kurunathan Ratnavelu, membahas tren dan implementasi kecerdasan buatan di berbagai sektor industri.<br><br>
  ...
  },
  {
    ...
    subtitle: "Kegiatan 7",
    date: "10 Juli 2025",
    description: `Melanjutkan rangkaian kegiatan internasionalnya di Malaysia, delegasi Himpunan Mahasiswa Sistem Informasi (HIMASI) Universitas Nasional melakukan kunjungan strategis ke Universiti Poly-Tech Malaysia (UPTM) pada Kamis, 10 Juli 2025.<br><br>
    Berbeda dengan agenda workshop di hari sebelumnya, kunjungan ke UPTM ini difokuskan pada sesi brainstorming dan diskusi mendalam mengenai potensi kemitraan (partnership) antar kedua institusi pendidikan.<br><br>
    Dalam pertemuan yang berlangsung hangat ini, perwakilan dosen dan mahasiswa UNAS berdiskusi dengan pihak UPTM mengenai berbagai peluang kolaborasi akademik masa depan. Tiga poin utama yang menjadi sorotan dalam diskusi tersebut meliputi:<br>
    1. Student Exchange: Membuka peluang bagi mahasiswa Sistem Informasi UNAS untuk merasakan pengalaman belajar satu atau dua semester di UPTM, dan sebaliknya.<br>
    2. Double Degree Program: Penjajakan kemungkinan program gelar ganda yang memungkinkan mahasiswa mendapatkan ijazah dari dua universitas sekaligus.<br>
    3. Visiting Professor: Program pertukaran dosen tamu untuk memperkaya materi perkuliahan dengan perspektif internasional.<br><br>
  ...
  },
  {
    ...
    KUALA LUMPUR – Dalam upaya mendukung kecerdasan digital generasi muda Indonesia di luar negeri, Himpunan Mahasiswa Sistem Informasi (HIMASI) bersama mahasiswa Fakultas Teknologi Komunikasi dan Informatika (FTKI) Universitas Nasional (UNAS) sukses menyelenggarakan kegiatan Pengabdian Kepada Masyarakat (PKM) Internasional.<br><br>
    Kegiatan yang berlangsung pada 10 Juli 2025 di Pusat Bimbingan Anak-Anak Pekerja Migran Indonesia (PMI). Mengusung tema besar “Empowering Digital Literacy: Introducing Information Systems”, para mahasiswa berusaha memberikan pemahaman dasar mengenai pentingnya teknologi informasi sejak dini.<br><br>
    Belajar Seru dengan Metode "Play and Learn" Menyadari bahwa audiens utama adalah anak-anak, tim PKM UNAS menerapkan metode pendekatan yang kreatif. Alih-alih memberikan materi yang kaku, mereka menggunakan konsep belajar sambil bermain. Strategi ini terbukti efektif dalam menjaga antusiasme anak-anak agar tidak mudah bosan selama sesi berlangsung.<br><br>
    Beberapa poin utama dalam kegiatan tersebut meliputi:<br>
    1. Edukasi Literasi Digital: Memberikan pemahaman tentang penggunaan teknologi secara bijak dan aman.<br>
    2. Pengenalan Sistem Informasi: Memperkenalkan konsep dasar teknologi yang relevan dengan kehidupan sehari-hari.<br>
    3. Interaksi Kreatif: Sesi pertanyaan edukatif yang dirancang untuk mengasah logika dan pengetahuan.<br><br>
    Kolaborasi untuk Dampak yang Lebih Luas<br>
    ...
    image: "/image/Home/Kegiatan/international-pkm-to-the-guidance-center-for-children-of-indonesian-migrant-workers.jpg",
    buttonText: "Baca",
    period: "2024/2025"
  },
  {
    ...
    subtitle: "Kegiatan 9",
    date: "10 Juli 2025",
    description: `Menutup rangkaian kegiatan akademik di Malaysia, Mahasiswa Sistem Informasi (HIMASI)  Universitas Nasional melakukan kunjungan kehormatan ke Kedutaan Besar Republik Indonesia (KBRI) di Kuala Lumpur.<br><br>
     Kunjungan yang berlangsung pada Kamis sore, 10 Juli 2025 ini disambut hangat oleh perwakilan atase pendidikan dan kebudayaan serta rekan-rekan dari Persatuan Pelajar Indonesia (PPI) Malaysia.<br><br>
