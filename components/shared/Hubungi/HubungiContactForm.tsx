...
import { ContactFormData } from "@/lib/type/Hubungi";

// Komponen form pengiriman pesan dan peta lokasi interaktif
export default function HubungiContactForm() {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-[#4B061A] via-[#732E39] to-[#994555] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Kartu Formulir dan Peta Google Maps */}
