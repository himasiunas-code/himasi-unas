...
import { activePartnerships, pastPartnerships } from "@/constants/KerjaSama";
import { getCategoryColor, formatDate, getYear } from "@/lib/kerjaSama";

// Komponen daftar logo dan riwayat kerja sama (kemitraan aktif dan terdahulu)
export default function KerjaSamaSlideLogo() {
  return (
    <main className="bg-[#4B061A] pb-16">
      <div className="container mx-auto px-4">
        {/* Seksi kemitraan yang sedang aktif berlangsung */}
        ...
        {/* Seksi riwayat kemitraan yang telah selesai */}
        ...
        {/* Status jika belum ada kemitraan */}
