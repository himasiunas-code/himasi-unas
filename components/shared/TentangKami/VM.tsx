    ...
    return(
        <main className="bg-[#FFE8DB] pt-10 pb-5 md:pb-10">
            <div className="w-full max-w-xs sm:max-w-md md:max-w-xl lg:max-w-4xl mx-auto px-4 flex justify-center flex-col items-center text-center gap-3 md:gap-5 pt-2">
                <h2 className="font-bold text-[#4B061A] text-xl md:text-2xl lg:text-4xl xl:text-6xl uppercase">Visi</h2>
            ...
            <div className="w-full max-w-6xl mx-auto px-4 flex justify-center items-center text-center pt-9 md:pt-12 lg:pt-15">
                <h2 className="font-bold text-[#4B061A] text-xl md:text-2xl lg:text-4xl xl:text-6xl uppercase">MISI</h2>
            </div>
                ...
                <div className="w-full">
                    <div className="hidden lg:block max-w-7xl mx-auto px-4">
                        <div className="grid grid-cols-4 gap-6">
                            {MISSION_DATA.map((mission) => (
                                <div key={mission.id} className="bg-[#4B061A] rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="lg:hidden">
                        ...
                        <div className="flex justify-center mt-4">
                            <p className="text-[#4B061A] text-xs opacity-70">← Geser untuk melihat lebih banyak →</p>
                        </div>
                    </div>
                </div>
            </div>
